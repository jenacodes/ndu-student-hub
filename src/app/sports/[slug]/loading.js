// components/SportsItemLoading.js
import { FaRegCalendarAlt } from "react-icons/fa";
import { HiOutlineUserGroup } from "react-icons/hi";
import { FaTags } from "react-icons/fa";

export default function SportsItemLoading() {
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
        <div className="max-w-3xl mx-auto bg-white p-6 sm:p-8 md:p-10 rounded-xl shadow-2xl -mt-16 sm:-mt-24 md:-mt-32 relative z-10">
          {/* Category Skeleton */}
          <div className="mb-4">
            <div className="inline-block bg-gray-200 text-transparent text-xs font-semibold px-3 py-1 rounded-full uppercase w-32 h-6 animate-pulse">
              Loading
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center text-sm text-gray-500 mb-6 gap-4">
            ...
            <div className="flex items-center">
              ...
              <div className="ml-2 h-4 bg-gray-200 rounded w-40 animate-pulse"></div>
            </div>
          </div>
          ...
          {/* Back to Sports Link Skeleton */}
          <div className="mt-10 pt-8 border-t border-gray-200 text-center">
            <div className="inline-block h-4 bg-gray-200 rounded w-40 animate-pulse"></div>
          </div>
        </div>
      </div>
    </div>
